                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="col-span-2 grid grid-cols-2 gap-6">
                        {facility.map((item, index) => (
                            <div
                                className="bg-rose-100 p-4 border-t-4 border-t-primary rounded-xl"
                                key={index}
                            >
                    ...
                    <div className="p-6 bg-gray-100">
                        ...
                        <Link href={`/checkout/${_id}`}>
                            <button className="btn bg-primary px-3 py-2 rounded-lg mt-2 w-full text-white">Proceed Checkout</button>
                        </Link>
                    </div>
                </div>
            </div>
